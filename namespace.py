...
def create(space, parent):
    namespaces[parent].append(space)
    namespaces[space] = [parent]

def add(space, var):
    namespaces[space].append(var)

def get(space, var):
    if var in namespaces[space]:
        print(space)
        return
    elif namespaces[space][0] != 'None':
        get(namespaces[space][0], var)
        return
    else:
        print('None')
        return
